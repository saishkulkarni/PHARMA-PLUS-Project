...
<script>
	...
	%>
		...
		<marquee behavior="" direction="right" scrollamount="10"><h3>Your Order is Ready To Dispatch!</h1></marquee>
	
	<table border="2px" cellpadding="20px">
	<tr style="font-weight: 700; font-size: 25px; background-image: linear-gradient(to bottom right,white,rgb(60, 59, 59));">
		<th>Name</th>
		<th>Medicine name</th>
		<th>Quantity</th>
		<th>Price</th>
